...
const SignUp = () => {
  ...
  return (
    <div className={`py-10 px-2 bg-auth`}>
      <section className="container mx-auto px-6 bg-auth min-h-[90vh] drop-shadow-2xl flex flex-col md:flex-row-reverse items-center py-8 text-black">
        <div className="flex-1 w-full ">
          <h3 className="text-center text-3xl md:text-4xl font-bold mb-2 text-black">
            Sign Up
          </h3>
          ...
          >
            <div className="flex flex-col gap-4 mb-6">
              ...
              <input
                ...
                className="input outline-none outline-blue-500 focus-within:outline-4 drop-shadow-sm px-4 md:px-6 rounded-lg text-black placeholder:text-[#a1a1a1]"
                type="text"
            ...
            <div className="flex flex-col gap-4 mb-6">
              ...
              <div className="w-full relative">
                <input
                  ...
                  className="input outline-none outline-blue-500 focus-within:outline-2 drop-shadow-sm px-4 md:px-6 rounded-lg text-black placeholder:text-[#a1a1a1] w-full"
                  type={"password"}
          ...
          <GoogleProvider />
          <div className="mt-8 text-xl text-black text-center">
            Already registered?{" "}
